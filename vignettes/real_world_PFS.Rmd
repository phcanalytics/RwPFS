...
The *id*, *baseline_date*, *last_activity_date* & *death_date* columns are self-explanatory. *visit_gap_start_date* indicates the date of the last visit before a longer gap in visits (e.g. 90 days) and is *NA* of no such gap occurs. The date up to which progression information is available for a particular patient is indicated in *last_progression_abstraction_date*. Lastly, there are a number of columns indicating the date of progression, with all except *progression_date_all_events* considering only a specific subset of progression events - we'll talk about that later.
